...
/____  > \___  >\___  >|__|_ \ \___  >|__|
	 \/      \/     \/      \/     \/        ''' + W)
	print('\n' + G + '[>]' + C + 'Update By : ' + W + 'TheBogaHacker')
	print(G + '[>]' + C + 'Edited By : ' + W + '    Maruf')
	print('\n' + G + '[>]' + C + ' Version    : ' + W + version + '\n')

def ver_check():
	print(G + '[+]' + C + ' Checking for Updates.....', end='')
	ver_url = 'https://raw.githubusercontent.com/rooted-cyber/seeker2/master/update.txt'
